...
[AUTOFAN](D11是訊號腳位)
@configuaration_adv.h
#define EXTRUDER_0_AUTO_FAN_PIN 11
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50
#define EXTRUDER_AUTO_FAN_SPEED   255 

[LASER](TTL腳位是D6  如有繼電器控制 D40)
@pins_RAMPS_13.h
...
//M902: Laser Driver Power OFF
 ...
 >#define CUSTOM_MACHINE_NAME   註解掉是 顯示"準備就緒" 
 >若要使用自己的configuration.h (也要是Marlin 1.1.0-RC2的 沒測試過其他版本可不可以)
 >只要在裡面加上 #define LASER_CONTROL 以及語言改為 tw 既可)
 >#define LANGUAGE_INCLUDE GENERATE_LANGUAGE_INCLUDE(tw) //這一行en改tw

Origin Marlin 1.1.0-RC2
https://github.com/MarlinFirmware/Marlin/archive/1.1.0-RC2.zip
*/
...
#define STRING_CONFIG_H_AUTHOR "(J, Z)" // Who made the changes.
...
//   #define CUSTOM_MACHINE_NAME "Prusa I3 Laser"
// #else
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0//-34     // Z probe to nozzle X offset: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0//8     // Z probe to nozzle Y offset: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.3//zhere  // Z probe to nozzle Z offset: -below (always!)
...
#define HOMING_FEEDRATE {800, 800, 100, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,3200,195}  // default steps per unit for Ultimaker
...
// en, tw, test
// See also language.h
#define LANGUAGE_INCLUDE GENERATE_LANGUAGE_INCLUDE(tw)
