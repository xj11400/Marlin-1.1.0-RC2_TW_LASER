 ...
 * M900 - Sxxx   Laser ttl (xxx = 0~255)
 * M901 - Laser power on
 * M902 - Laser power off
...
//Add initialize PIN output Low
    ...
    digitalWrite(LASER_TTL_PIN, laser_driver_ttl);
  #endif
...
#if ENABLED(LASER_CONTROL)
laser_driver_ttl = code_seen('S') ? constrain(code_value_short(), 0, 255) : 255;
#endif
    prepare_move();
  }
}
...
/**
 * LASER CONTROL
 * M900, M901, M902 codes
 * M900 Sxxx: Laser Modulation command
 * M901: LASER Driver Power On command
 * M902: Laser Driver Power OFF command
 */
#if ENABLED(LASER_CONTROL)
//M900 Laser TTL modulation control(PWM)
inline void gcode_M900() { laser_driver_ttl = code_seen('S') ? constrain(code_value_short(), 0, 255) : 255;}
//M901 Laser driver power on
inline void gcode_M901() {
 digitalWrite(LASER_POWER_PIN, HIGH);
  laser_driver_ttl = 0;}
//M902 Laser driver power off
inline void gcode_M902() {
digitalWrite(LASER_POWER_PIN, LOW);
  laser_driver_ttl = 0;}
#endif
...
void process_next_command() {
  ...
  switch(command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      #if ENABLED(LASER_CONTROL)
        case 900: // M900: laser ttl
          gcode_M900();
          break;
        case 901: // M901: laser On
          gcode_M901();
          break;
        case 902: // M902: laser Off
          gcode_M902();
          break;
      #endif
